...
export const Dashboard: React.FC = () => {
  return (
    <div className="main-padding relative mx-auto flex h-fit grow flex-col items-start justify-start gap-4 2xl:max-w-[1200px]">
      ...
      <div className="grid h-fit w-full grid-cols-1 gap-4 px-1 sm:px-6 md:grid-cols-7">
        ...
        <StepperCard className="col-span-1 md:col-span-4" />
      </div>
